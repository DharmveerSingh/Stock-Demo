...
import ca.gl.fus.dao.StockHistoryListRepository;
import ca.gl.fus.dao.StockRepository;
...
public class ScheduledTasks {
	 ...
	 *
	 * @param date the date
	 * @return the function<? super stock history list,? extends publisher<? extends stock history list>>
	 */
	 ...
	 * @param date the date
	 * @param shl the shl
	 * @return the publisher<? extends stock history list>
	 */
