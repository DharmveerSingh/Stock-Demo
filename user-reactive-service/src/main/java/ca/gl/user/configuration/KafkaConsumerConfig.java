...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, Transaction> buyResultConsumerFactory() {
		Map<String, Object> props = new HashMap<>();
		props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
		props.put(ConsumerConfig.GROUP_ID_CONFIG, "buyResult");
	 ...
	 */
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Transaction> buyResultKafkaListenerContainerFactory() {
